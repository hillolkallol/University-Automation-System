...
if(isset($_POST['recover']))
{
   ...
   {
      $query2="SELECT * FROM tbl_teacher_info WHERE tch_id='".$username."'";
      $query_run2 = mysql_query($query2);
      $to = mysql_result($query_run2, 0, 'tch_email');
      $subject = "Password Recovery";

      $link="http://".$_SERVER['SERVER_NAME']."/Automation/teacher_password_recovery.php?user=".$username."&hash=".$unique_hash;
      echo $link;
...
<!---------------------------------form Starts---------------------------------------------->
                              <form action="<?php echo $current_file;?>" method="POST">
                                 <div class="form-group input-group">
                                    ...
                                    <input type="text" name="user_id" placeholder="Teacher ID" class="form-control input" required="required">
                                 </div>
                                 <div class="form-group input-group">
                               ...
                               <!-- Modal -->
                                 ...
                                 <form action="<?php echo $current_file;?>" method="POST" id="std_register" name="std_register" enctype="multipart/form-data">
                                             <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">Enter your ID</h4>
                                             </div>
