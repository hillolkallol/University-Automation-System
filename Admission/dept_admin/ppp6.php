...
echo '<tr><td><P style="color:#31B0D5;font-family:sans-serif">'.forteacherName($row2['offer_teacher_id']).'</p></td>
	...
	<td><p><a href="delete_updated.php?id='.foroffer($row2['offer_auto_id']).';"class="btn btn-sm btn-danger delete" onclick="return confirm_delete();"> Delete</a></p></td>
    <tr>
    ';
}
