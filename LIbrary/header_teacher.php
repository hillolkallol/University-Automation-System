						...
						if(isset($_SESSION['teacher_id']))
								{
									...
									$query="select * from tbl_teacher_info where tch_id='$user_id'";
								...
								<div class="container-fluid navdiv" style=" background:#3276b1 !important; color:#3276b1 !important;">
									...
									<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
										<ul class="nav navbar-nav">
											<li class=""><a href="home_teacher.php" class="icon_menu"><i class="icon-home icon_style"></i>Home<span class="sr-only">(current)</span></a></li>
											<li class=""><a href="books_teacher.php" class="icon_menu"><i class="icon-book icon_style"></i>Books</a></li>
											<li class=""><a href="about_teacher.php" class="icon_menu"><i class="icon-info-sign icon_style"></i>About</a></li>
											<li class=""><a href="contact_teacher.php" class="icon_menu"><i class="icon-phone icon_style"></i>Contact</a></li>
											<li class="dropdown d_class" >
												...
												<ul class="dropdown-menu manue_class" role="menu" aria-labelledby="dLabel">
													<li><a href="teacher.php">My Profile</a></li>
													<li><a href="../welcome_teacher.php">Main Menu</a></li>
													<li><a href=""  data-toggle="modal" data-target="#change_pass"style="color:black !important;">Change Password</a></li>
													<li><a href="../Admission/logout_teacher.php">Logout</a></li>
												</ul>
											</li>
										</ul>
									</div><!-- /.navbar-collapse -->
