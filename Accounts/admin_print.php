...
/////generate starts
	...
	if(isset($_GET['generate']))
	{
		...
		if(empty($studentId) || empty($payCategory) || empty($season) || empty($year))
		{
			echo '<script type="text/javascript"> alert("Fill all the fields!") 
			window.location.href="admin_fees.php"	</script>';
		}
		else
		{
			$printCount = 0;
...
<!------------------------------------------------------------------------------------>							
								...
								<div class="form_sep">
                                 ...
                                 <div class="form_sep">
                                   ...
                                   <input type="text" name="keepingDue" value="<?php 
									...
									?>" class="form-control" placeholder="" <?php 
									if($keepingDue!=0 || $payCategory!=1 || $creditFeePayment==1)
										echo 'readonly'; 
						...
						<br><br><br><hr>	
							...
							<div class="row">
								<div class="col-md-1"><a style="margin-top:15px; font-size: 40px"  class="fa fa-hand-o-left" href="<?php echo $_SERVER['HTTP_REFERER']; ?>"></a></div>
