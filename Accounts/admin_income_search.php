<?php 
	...
	if(isset($_POST['searchTrans']))
	{
		...
		else
		{
			...
			$query2 = "SELECT * FROM descriptions_list WHERE category='income' AND part='others'";
               ...
               <div class="panel panel-default">
				  ...
				  <form action="<?php echo $current_file;?>" method="POST" id="std_register" name="std_register" enctype="multipart/form-data">
                     ...
                     <div class="form_sep">
						...
						if(isset($_POST['searchTrans']))
						{
							$query = "SELECT * FROM all_transactions WHERE tNo='".$transNo."' AND category= 'income' AND description='".$description."'";
							if($query_run = mysql_query($query))
							{
