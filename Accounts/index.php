...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Leading University | Accounting Section</title>
				...
				<div class="row">
					...
					<div class="col-md-7">
						<div class="header_top text-right">
							<ul>
								<li><i class="fa fa-phone heading_icon"></i>+88-0821-720303-6</li>
								<li><i class="fa fa-envelope heading_icon"></i>mail@cse26.net</li>
							</ul>
						</div>
					</div>
				</div>
		...
		<div class="welcome_content">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="welcome">
							<h1>Welcome To Leading University <br />Automation System <br /></h1>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="more">
							<h4>For Continue Plz...&nbsp; &nbsp; &nbsp;<a href="login.php" class="btn btn-info"><i class="fa fa-hand-o-right"></i>&nbsp;Click Here!</a></h4>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="footer_left">
							<ul>
								<li><a href="faq.html">FAQ</a></li>
                                 ...
                                 <li><a href="condition.html">Term &amp; Condition</a></li>
                                 <li><a href="contact.html">Contact</a></li>
							</ul>
						</div>
					</div>
					<div class="col-md-6"><div class="copy">
