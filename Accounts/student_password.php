                           ...
                           <div class="single_login">
                              ...
                              <form action="<?php echo $current_file;?>" method="POST">
                                 <div class="form-group">
                                    <input name="oldpass" type="password" placeholder="Your Current Password" class="form-control input">
                                 </div>
                                 <div class="form-group">
                                    <input name="newpass" type="password" placeholder="New Password" class="form-control input">
                                 </div>
                                 <div class="form-group">
                                    <input name="renewpass" type="password" placeholder="Re-Type Password" class="form-control input">
                                 </div>
                                 <div class="form-group">
